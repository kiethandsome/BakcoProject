...
//    }()
    ...
    @IBAction func showHospitals(_ sender: Any) {
        ...
        hospitalVc.direction = DirectViewController.teleHealth
...
extension TeleHealthViewController {
        ...
        case exTypeDropdown:
            ...
            dropdown.selectionAction =  { (index: Int, item: String) in
                ...
                if BookingInfo.serviceType.canChooseDoctor {
                    ...
                    self.ExpDocOrSpecialtyLabel.text = "5. Chuyên gia tư vấn:"
                    self.expDocOrSpecialtyTextfield.placeholder = "Chọn chuyên gia"
                } else {
                    // Luồng khám thông thường và dịch vụ
                    self.ExpDocOrSpecialtyLabel.text = "5. Chuyên khoa tư vấn:"
    ...
    fileprivate func showExpDoc() {
        ...
        doctorVc.direction = DirectViewController.teleHealth
    ...
    fileprivate func showSpecialty() {
        if hospitalTextfield.text != "" {
            ...
            next.direction = DirectViewController.teleHealth
...
extension TeleHealthViewController {
    ...
    func getHospitalServiceTypes(hospitalId: Int) {
        self.showHUD()
        let url = URL(string: API.getHospitalServiceTypes + "?HospitalId=" + "\(hospitalId)" + "&Form=2")!
...
extension TeleHealthViewController: ChooseSpecialtyViewControllerDelegate {
...
extension TeleHealthViewController: SchedulersViewControllerDelegate {
